...
\begin{enumerate}
        ...
        \begin{itemize}
          ...
          \item Proširen skup podržanih ciljnih funkcija implementacijom funkcije unakrsne entropije.
          ...
          \item Paralelizovana obuka modela pomoću simuliranog federalnog obučavanja (\textit{simulated federated learning}). Način implementacije jeste podeliti proces obuke na $N$ niti, gde svaka nit ima poseban deo trening skupa podataka i nakon svake iteracije (ili nekoliko iteracija) izračunati prosek svih gradijenata i iskoristiti ih za ažuriranje modela. Ovaj metod federalnog obučavanja se naziva simuliranim jer se model obučava na istoj fizičkoj mašini.
