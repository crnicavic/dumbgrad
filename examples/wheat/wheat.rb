require '/home/user/Desktop/projekti/nn-proof-of-concept/nn.rb'
...
data = CSV.read("wheat-seeds.csv", converters: :numeric)
x = data.map{|row| row[0..-2]}
y = Array.new(x.length) {Array.new(type_count) {0}}
...
net = Network.new([iln, iln*2, iln*2, type_count], lr=0.005)
